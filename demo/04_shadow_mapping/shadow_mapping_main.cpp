...
using namespace std;
using namespace CGL;
vec3 light_pos = vec3(0.f, 1.8f, 1.8f);
class LightScene :public Scene {
public:
    virtual void update() {
        float delta_time = 10;
        CGL::mat4 red_light_model = CGL::rotate(CGL::mat4(1.0f), (float)delta_time * 0.008f, CGL::vec3(0, 1, 0));
        light_pos = vec3(red_light_model * vec4(light_pos, 1.0f));
...
std::shared_ptr<LightScene> setScene() {
    ...
    std::string char_path = "../../../asset/model/african_head/african_head.obj";
    std::string char_tex_path = "../../../asset/model/african_head/african_head_diffuse.png";
    std::string floor_path = "../../../asset/model/floor/floor.obj";
    std::string floor_tex_path = "../../../asset/model/floor/floor_wood.png";

    RenderObject character = createRenderObject(char_path, char_tex_path, vec3(0, 0, 0), vec3(1, 1, 1));
    ...
    std::string cube_filename = "../../../asset/model/cube/cube.obj";
    RenderObject lightobj= createRenderObject(cube_filename, vec3(1.0f,1.0f,1.0f), vec3(0.f, 1.8f, 1.8f), vec3(1, 1, 1));
   
  
    auto light = std::make_shared<PointLight>(vec3(0.1f, 0.1f, 0.1f), vec3(0.f, 1.8f, 1.8f),
        vec3(0.002f, 0.01f, 0.03f)); 
